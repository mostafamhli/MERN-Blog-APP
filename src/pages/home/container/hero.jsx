  ...
  return (
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-10 lg:w-1/2">
        ...
        <p className="mt-4 text-dark-light text-center md:text-xl lg:text-base xl:text-xl lg:text-left">
        ...
        <div className="flex flex-col gap-y-2.5 mt-10 lg:mt-6 xl:mt-10 relative">
          <div className="relative">
            ...
            <input
              className="placeholder:font-bold placeholder:text-[#959aed] font-semibold text-dark-soft pl-12 pr-3 py-3 w-full rounded-lg focus:outline-none  shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] md:py-4"
              type="text"
