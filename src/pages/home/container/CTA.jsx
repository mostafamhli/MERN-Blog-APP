        ...
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
            ...
            <div className="w-full max-w-[494px] mt-12 space-y-3 mx-auto md:space-y-0 md:flex md:items-center md:space-x-2 lg:mx-0">
              ...
              <button className="px-4 py-3 rounded-lg w-full font-bold md:w-fit md:whitespace-nowrap text-white bg-primary hover:text-primary hover:bg-white transition-all duration-300">
                Get started
              </button>
            </div>
            <p className="text-dark-light taxt-sm leading-7 mt-6 md:text-center md:text-base lg:text-left">
